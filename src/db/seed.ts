...
export async function seedDatabase() {
  ...
  const players: Omit<Player, 'id'>[] = [
    { name: 'Marco', emoji: '🎯', createdAt: new Date('2025-09-01'), isActive: true },
    { name: 'Sofia', emoji: '🔥', createdAt: new Date('2025-09-01'), isActive: true },
    { name: 'Luca', emoji: '🍀', createdAt: new Date('2025-09-01'), isActive: true },
    { name: 'Elena', emoji: '💎', createdAt: new Date('2025-09-01'), isActive: true },
    { name: 'Alex', emoji: '🐺', createdAt: new Date('2025-09-15'), isActive: true },
